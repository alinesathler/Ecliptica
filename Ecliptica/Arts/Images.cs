...
namespace Ecliptica.Arts
{
	public static class Images
	{
		...
		public static void Load(ContentManager content, GraphicsDevice graphicsDevice)
		{
			...
			{
				content.Load<Texture2D>("Images/life-bar-animated-0"),
				content.Load<Texture2D>("Images/life-bar-animated-1"),
				content.Load<Texture2D>("Images/life-bar-animated-2"),
				content.Load<Texture2D>("Images/life-bar-animated-3"),
				content.Load<Texture2D>("Images/life-bar-animated-4"),
				content.Load<Texture2D>("Images/life-bar-animated-5"),
				content.Load<Texture2D>("Images/life-bar-animated-6"),
				content.Load<Texture2D>("Images/life-bar-animated-7"),
				content.Load<Texture2D>("Images/life-bar-animated-8")
			};
